...
CFG.SCRIPT_FUNC = {						--脚本功能列表
	...
	whiteList = {						--功能限制列表，通过白名单形式限制个脚本的功能，用于同时维护多个脚本,func为空是代表全白名单
		...
		{scriptid = 23354, distributions = "安卓-叉叉助手免费版", tips = "免费版将于7月2日过期，欢迎使用“【稳定版】实况助手”，可在叉叉助手搜索脚本ID:16489，或进群574025168下载。6.29-7.1限时8折优惠",
			func = {"自动天梯","自动联赛","自动巡回","手动巡回","自动冠军赛"}},
		{scriptid = 16498, distributions = "安卓-叉叉助手/小精灵测试版", tips = "测试版将于7月2日过期，欢迎使用“【稳定版】实况助手”，可在叉叉助手搜索脚本ID:16489，或进群574025168下载。6.29-7.1限时8折优惠",
			func = {}},
		{scriptid = 24391, distributions = "安卓-叉叉助手(国际服)版",
			func = {"国际服季节赛SIM","国际服巡回赛SIM"}},
		{scriptid = 24090, distributions = "安卓-小精灵(国际服免费)版", tips = "不要在闲鱼购买！本来是免费给大家试用几个月的，被奸商拿来卖钱，现废弃免费版！7月2以后将不能使用！需要可加群696059906",
			func = {"国际服季节赛SIM","国际服巡回赛SIM"}},
		...
		{scriptid = 16947, distributions = "IOS-IPA版",
			func = {"自动天梯","自动联赛","自动巡回","手动巡回","自动冠军赛"}},
		{scriptid = 23355, distributions = "IOS-IPA免费版", tips = "免费版将于7月2日过期，欢迎使用“【稳定版】实况助手”，可直接搜索脚本ID:16947，6.29-7.1限时8折优惠",
			func = {"自动天梯","自动联赛","自动巡回","手动巡回","自动冠军赛"}},
		{scriptid = 18134, distributions = "IOS-IPA测试版", tips = "测试版将于7月2日过期，欢迎使用“【稳定版】实况助手”，可直接搜索脚本ID:16947，6.29-7.1限时8折优惠",
			func = {}},
