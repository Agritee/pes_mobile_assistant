...
M.words = {					
	...
	"fasten", "fatal", "fate", "father", "father-in-law", "fatigue", "fault", "faulty", "favour", "favourable",
	...
	"hurry", "hurt", "husband", "hut", "hydrogen", "I", "ice", "ice-cream", "idea", "ideal",
	...
	"literary", "literature", "little", "live", "lively", "liver", "living", "living-room", "load", "loaf",
	...
	"so-called", "soccer", "social", "socialism", "socialist", "society", "sock", "soda", "soft", "softly",
	...
	"upright", "upset", "upside-down", "upstairs", "up-to-date", "upward", "upwards", "urge", "urgent", "us",
	...
	"well", "well", "well-known", "west", "western", "westward", "wet", "what", "whatever", "wheat",
	...
	"world-wide", "worm", "worry", "worse", "worship", "worst", "worth", "worthless", "worthwhile", "worthy",
	"would", "wound", "wrap", "wreath", "wreck", "wrist", "write", "writer", "writing", "wrong",
	"X-ray", "yard", "yard", "yawn", "year", "yearly", "yell", "yellow", "yes", "yesterday",
