...
pageTestting:nextLine()
pageTestting:addLabel({text="    14.脚本只是模拟点击，无任何修改数据，理论上不可能封号，至目前用了一年多没任何问题，但风险自担。",size=20, align="left"})
pageTestting:nextLine()
pageTestting:addLabel({text="    15.有任何问题及建议请反馈给作者，Q群(加群原因请回答:实况脚本)：国服574025168，国际服696059906 ",size=20, align="left"})
pageTestting:nextLine()
pageTestting:nextLine()
